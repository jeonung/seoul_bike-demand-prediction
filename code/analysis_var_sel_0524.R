...
data_3582 = read.csv(paste0("./data/", version, "/", y_name, "/analysis_data/화양동 우체국_3582_",
                            y_name, "_data.csv"))
data_3508 = read.csv(paste0("./data/", version, "/", y_name, "/analysis_data/건국대학교 (입학정보관)_590_",
                            y_name, "_data.csv"))
gu = read.csv(paste0("./data/", version, "/", y_name, "/analysis_data/광진구_unif_",
                     y_name, "_data.csv"))
dong = read.csv(paste0("./data/", version, "/", y_name, "/analysis_data/화양동_unif_",
                       y_name, "_data.csv"))
...
for (iter in 1:n_cv_tt){
    ...
    ### individual station ###
    # random forest
    rf_test_3508 = rf_data_3508[test_idx, ]
    rf_test_3523 = rf_data_3523[test_idx, ]
    rf_test_3569 = rf_data_3569[test_idx, ]
    rf_test_3571 = rf_data_3571[test_idx, ]
    rf_test_3579 = rf_data_3579[test_idx, ]
    rf_test_3582 = rf_data_3582[test_idx, ]
    rf_test_3860 = rf_data_3860[test_idx, ]
    rf_test_500 = rf_data_500[test_idx, ]
    rf_test_590 = rf_data_590[test_idx, ]
    rf_test_591 = rf_data_591[test_idx, ]
    rf_test_592 = rf_data_592[test_idx, ]

    # elastic net
    elnet_test_3508 = elnet_data_3508[test_idx, ]
    elnet_test_3523 = elnet_data_3523[test_idx, ]
    elnet_test_3569 = elnet_data_3569[test_idx, ]
    elnet_test_3571 = elnet_data_3571[test_idx, ]
    elnet_test_3579 = elnet_data_3579[test_idx, ]
    elnet_test_3582 = elnet_data_3582[test_idx, ]
    elnet_test_3860 = elnet_data_3860[test_idx, ]
    elnet_test_500 = elnet_data_500[test_idx, ]
    elnet_test_590 = elnet_data_590[test_idx, ]
    elnet_test_591 = elnet_data_591[test_idx, ]
    elnet_test_592 = elnet_data_592[test_idx, ]

    # xgboost
    xg_test_3508 = xg_data_3508[test_idx, ]
    xg_test_3523 = xg_data_3523[test_idx, ]
    xg_test_3569 = xg_data_3569[test_idx, ]
    xg_test_3571 = xg_data_3571[test_idx, ]
    xg_test_3579 = xg_data_3579[test_idx, ]
    xg_test_3582 = xg_data_3582[test_idx, ]
    xg_test_3860 = xg_data_3860[test_idx, ]
    xg_test_500 = xg_data_500[test_idx, ]
    xg_test_590 = xg_data_590[test_idx, ]
    xg_test_591 = xg_data_591[test_idx, ]
    xg_test_592 = xg_data_592[test_idx, ]
    ...
    for (iiter in 1:n_cv_tv){
        ...
        ### individual station ###
        # random forest
        rf_train_3508 = rf_data_3508[train_idx, ]
        rf_train_3523 = rf_data_3523[train_idx, ]
        rf_train_3569 = rf_data_3569[train_idx, ]
        rf_train_3571 = rf_data_3571[train_idx, ]
        rf_train_3579 = rf_data_3579[train_idx, ]
        rf_train_3582 = rf_data_3582[train_idx, ]
        rf_train_3860 = rf_data_3860[train_idx, ]
        rf_train_500 = rf_data_500[train_idx, ]
        rf_train_590 = rf_data_590[train_idx, ]
        rf_train_591 = rf_data_591[train_idx, ]
        rf_train_592 = rf_data_592[train_idx, ]
        rf_train_gu = rf_gu[train_idx, ]
        rf_train_dong = rf_dong[train_idx, ]

        # elastic net
        elnet_train_3508 = elnet_data_3508[train_idx, ]
        elnet_train_3523 = elnet_data_3523[train_idx, ]
        elnet_train_3569 = elnet_data_3569[train_idx, ]
        elnet_train_3571 = elnet_data_3571[train_idx, ]
        elnet_train_3579 = elnet_data_3579[train_idx, ]
        elnet_train_3582 = elnet_data_3582[train_idx, ]
        elnet_train_3860 = elnet_data_3860[train_idx, ]
        elnet_train_500 = elnet_data_500[train_idx, ]
        elnet_train_590 = elnet_data_590[train_idx, ]
        elnet_train_591 = elnet_data_591[train_idx, ]
        elnet_train_592 = elnet_data_592[train_idx, ]
        elnet_train_gu = elnet_gu[train_idx, ]
        elnet_train_dong = elnet_dong[train_idx, ]

        # xgboost
        xg_train_3508 = xg_data_3508[train_idx, ]
        xg_train_3523 = xg_data_3523[train_idx, ]
        xg_train_3569 = xg_data_3569[train_idx, ]
        xg_train_3571 = xg_data_3571[train_idx, ]
        xg_train_3579 = xg_data_3579[train_idx, ]
        xg_train_3582 = xg_data_3582[train_idx, ]
        xg_train_3860 = xg_data_3860[train_idx, ]
        xg_train_500 = xg_data_500[train_idx, ]
        xg_train_590 = xg_data_590[train_idx, ]
        xg_train_591 = xg_data_591[train_idx, ]
        xg_train_592 = xg_data_592[train_idx, ]
        ...
        ### individual station ###
        # random forest
        rf_val_3508 = rf_data_3508[val_idx, ]
        rf_val_3523 = rf_data_3523[val_idx, ]
        rf_val_3569 = rf_data_3569[val_idx, ]
        rf_val_3571 = rf_data_3571[val_idx, ]
        rf_val_3579 = rf_data_3579[val_idx, ]
        rf_val_3582 = rf_data_3582[val_idx, ]
        rf_val_3860 = rf_data_3860[val_idx, ]
        rf_val_500 = rf_data_500[val_idx, ]
        rf_val_590 = rf_data_590[val_idx, ]
        rf_val_591 = rf_data_591[val_idx, ]
        rf_val_592 = rf_data_592[val_idx, ]
        rf_val_gu = rf_gu[val_idx, ]
        rf_val_dong = rf_dong[val_idx, ]

        # elastic net
        elnet_val_3508 = elnet_data_3508[val_idx, ]
        elnet_val_3523 = elnet_data_3523[val_idx, ]
        elnet_val_3569 = elnet_data_3569[val_idx, ]
        elnet_val_3571 = elnet_data_3571[val_idx, ]
        elnet_val_3579 = elnet_data_3579[val_idx, ]
        elnet_val_3582 = elnet_data_3582[val_idx, ]
        elnet_val_3860 = elnet_data_3860[val_idx, ]
        elnet_val_500 = elnet_data_500[val_idx, ]
        elnet_val_590 = elnet_data_590[val_idx, ]
        elnet_val_591 = elnet_data_591[val_idx, ]
        elnet_val_592 = elnet_data_592[val_idx, ]
        elnet_val_gu = elnet_gu[val_idx, ]
        elnet_val_dong = elnet_dong[val_idx, ]

        # xgboost
        xg_val_3508 = xg_data_3508[val_idx, ]
        xg_val_3523 = xg_data_3523[val_idx, ]
        xg_val_3569 = xg_data_3569[val_idx, ]
        xg_val_3571 = xg_data_3571[val_idx, ]
        xg_val_3579 = xg_data_3579[val_idx, ]
        xg_val_3582 = xg_data_3582[val_idx, ]
        xg_val_3860 = xg_data_3860[val_idx, ]
        xg_val_500 = xg_data_500[val_idx, ]
        xg_val_590 = xg_data_590[val_idx, ]
        xg_val_591 = xg_data_591[val_idx, ]
        xg_val_592 = xg_data_592[val_idx, ]
    ...
    ### individual station ###
    # random forest
    rf_train_val_3508 = rf_data_3508[-test_idx, ]
    rf_train_val_3523 = rf_data_3523[-test_idx, ]
    rf_train_val_3569 = rf_data_3569[-test_idx, ]
    rf_train_val_3571 = rf_data_3571[-test_idx, ]
    rf_train_val_3579 = rf_data_3579[-test_idx, ]
    rf_train_val_3582 = rf_data_3582[-test_idx, ]
    rf_train_val_3860 = rf_data_3860[-test_idx, ]
    rf_train_val_500 = rf_data_500[-test_idx, ]
    rf_train_val_590 = rf_data_590[-test_idx, ]
    rf_train_val_591 = rf_data_591[-test_idx, ]
    rf_train_val_592 = rf_data_592[-test_idx, ]
    rf_train_val_gu = rf_gu[-test_idx, ]
    rf_train_val_dong = rf_dong[-test_idx, ]

    # elastic net
    elnet_train_val_3508 = elnet_data_3508[-test_idx, ]
    elnet_train_val_3523 = elnet_data_3523[-test_idx, ]
    elnet_train_val_3569 = elnet_data_3569[-test_idx, ]
    elnet_train_val_3571 = elnet_data_3571[-test_idx, ]
    elnet_train_val_3579 = elnet_data_3579[-test_idx, ]
    elnet_train_val_3582 = elnet_data_3582[-test_idx, ]
    elnet_train_val_3860 = elnet_data_3860[-test_idx, ]
    elnet_train_val_500 = elnet_data_500[-test_idx, ]
    elnet_train_val_590 = elnet_data_590[-test_idx, ]
    elnet_train_val_591 = elnet_data_591[-test_idx, ]
    elnet_train_val_592 = elnet_data_592[-test_idx, ]
    elnet_train_val_gu = elnet_gu[-test_idx, ]
    elnet_train_val_dong = elnet_dong[-test_idx, ]

    # xgboost
    xg_train_val_3508 = xg_data_3508[-test_idx, ]
    xg_train_val_3523 = xg_data_3523[-test_idx, ]
    xg_train_val_3569 = xg_data_3569[-test_idx, ]
    xg_train_val_3571 = xg_data_3571[-test_idx, ]
    xg_train_val_3579 = xg_data_3579[-test_idx, ]
    xg_train_val_3582 = xg_data_3582[-test_idx, ]
    xg_train_val_3860 = xg_data_3860[-test_idx, ]
    xg_train_val_500 = xg_data_500[-test_idx, ]
    xg_train_val_590 = xg_data_590[-test_idx, ]
    xg_train_val_591 = xg_data_591[-test_idx, ]
    xg_train_val_592 = xg_data_592[-test_idx, ]
    ...
    # Fitting
    rf_best_fit_3508 = randomForest(y ~., data=rf_train_val_3508, 
                                    ntree=rf_best_com_3508$ntree, mtry=rf_best_com_3508$mtry)
    rf_best_fit_3523 = randomForest(y ~., data=rf_train_val_3523, 
                                    ntree=rf_best_com_3523$ntree, mtry=rf_best_com_3523$mtry)
    rf_best_fit_3569 = randomForest(y ~., data=rf_train_val_3569, 
                                    ntree=rf_best_com_3569$ntree, mtry=rf_best_com_3569$mtry)
    rf_best_fit_3571 = randomForest(y ~., data=rf_train_val_3571, 
                                    ntree=rf_best_com_3571$ntree, mtry=rf_best_com_3571$mtry)
    rf_best_fit_3579 = randomForest(y ~., data=rf_train_val_3579, 
                                    ntree=rf_best_com_3579$ntree, mtry=rf_best_com_3579$mtry)
    rf_best_fit_3582 = randomForest(y ~., data=rf_train_val_3582, 
                                    ntree=rf_best_com_3582$ntree, mtry=rf_best_com_3582$mtry)
    rf_best_fit_3860 = randomForest(y ~., data=rf_train_val_3860, 
                                    ntree=rf_best_com_3860$ntree, mtry=rf_best_com_3860$mtry)
    rf_best_fit_500 = randomForest(y ~., data=rf_train_val_500, 
                                    ntree=rf_best_com_500$ntree, mtry=rf_best_com_500$mtry)
    rf_best_fit_590 = randomForest(y ~., data=rf_train_val_590, 
                                    ntree=rf_best_com_590$ntree, mtry=rf_best_com_590$mtry)
    rf_best_fit_591 = randomForest(y ~., data=rf_train_val_591, 
                                    ntree=rf_best_com_591$ntree, mtry=rf_best_com_591$mtry)
    rf_best_fit_592 = randomForest(y ~., data=rf_train_val_592, 
    ...
    rf_best_mse_3508 = calculate_mse(model='rf', fit=rf_best_fit_3508, rf_train_val_3508)
    rf_best_mse_3523 = calculate_mse(model='rf', fit=rf_best_fit_3523, rf_train_val_3523)
    rf_best_mse_3569 = calculate_mse(model='rf', fit=rf_best_fit_3569, rf_train_val_3569)
    rf_best_mse_3571 = calculate_mse(model='rf', fit=rf_best_fit_3571, rf_train_val_3571)
    rf_best_mse_3579 = calculate_mse(model='rf', fit=rf_best_fit_3579, rf_train_val_3579)
    rf_best_mse_3582 = calculate_mse(model='rf', fit=rf_best_fit_3582, rf_train_val_3582)
    rf_best_mse_3860 = calculate_mse(model='rf', fit=rf_best_fit_3860, rf_train_val_3860)
    rf_best_mse_500 = calculate_mse(model='rf', fit=rf_best_fit_500, rf_train_val_500)
    rf_best_mse_590 = calculate_mse(model='rf', fit=rf_best_fit_590, rf_train_val_590)
    rf_best_mse_591 = calculate_mse(model='rf', fit=rf_best_fit_591, rf_train_val_591)
    rf_best_mse_592 = calculate_mse(model='rf', fit=rf_best_fit_592, rf_train_val_592)
    ...
    rf_test_mse_3508 = calculate_mse(model='rf', fit=rf_best_fit_3508, rf_test_3508)
    rf_test_mse_3523 = calculate_mse(model='rf', fit=rf_best_fit_3523, rf_test_3523)
    rf_test_mse_3569 = calculate_mse(model='rf', fit=rf_best_fit_3569, rf_test_3569)
    rf_test_mse_3571 = calculate_mse(model='rf', fit=rf_best_fit_3571, rf_test_3571)
    rf_test_mse_3579 = calculate_mse(model='rf', fit=rf_best_fit_3579, rf_test_3579)
    rf_test_mse_3582 = calculate_mse(model='rf', fit=rf_best_fit_3582, rf_test_3582)
    rf_test_mse_3860 = calculate_mse(model='rf', fit=rf_best_fit_3860, rf_test_3860)
    rf_test_mse_500 = calculate_mse(model='rf', fit=rf_best_fit_500, rf_test_500)
    rf_test_mse_590 = calculate_mse(model='rf', fit=rf_best_fit_590, rf_test_590)
    rf_test_mse_591 = calculate_mse(model='rf', fit=rf_best_fit_591, rf_test_591)
    rf_test_mse_592 = calculate_mse(model='rf', fit=rf_best_fit_592, rf_test_592)
    ...
    elnet_best_fit_3508 = glmnet(x=elnet_train_val_3508[, -1], y=elnet_train_val_3508[, 1], 
                                 alpha=elnet_best_com_3508$alpha, lambda=elnet_best_com_3508$alpha)
    elnet_best_fit_3523 = glmnet(x=elnet_train_val_3523[, -1], y=elnet_train_val_3523[, 1], 
                                 alpha=elnet_best_com_3523$alpha, lambda=elnet_best_com_3523$alpha)
    elnet_best_fit_3569 = glmnet(x=elnet_train_val_3569[, -1], y=elnet_train_val_3569[, 1], 
                                 alpha=elnet_best_com_3569$alpha, lambda=elnet_best_com_3569$alpha)
    elnet_best_fit_3571 = glmnet(x=elnet_train_val_3571[, -1], y=elnet_train_val_3571[, 1], 
                                 alpha=elnet_best_com_3571$alpha, lambda=elnet_best_com_3571$alpha)
    elnet_best_fit_3579 = glmnet(x=elnet_train_val_3579[, -1], y=elnet_train_val_3579[, 1], 
                                 alpha=elnet_best_com_3579$alpha, lambda=elnet_best_com_3579$alpha)
    elnet_best_fit_3582 = glmnet(x=elnet_train_val_3582[, -1], y=elnet_train_val_3582[, 1], 
                                 alpha=elnet_best_com_3582$alpha, lambda=elnet_best_com_3582$alpha)
    elnet_best_fit_3860 = glmnet(x=elnet_train_val_3860[, -1], y=elnet_train_val_3860[, 1], 
                                 alpha=elnet_best_com_3860$alpha, lambda=elnet_best_com_3860$alpha)
    elnet_best_fit_500 = glmnet(x=elnet_train_val_500[, -1], y=elnet_train_val_500[, 1], 
                                 alpha=elnet_best_com_500$alpha, lambda=elnet_best_com_500$alpha)
    elnet_best_fit_590 = glmnet(x=elnet_train_val_590[, -1], y=elnet_train_val_590[, 1], 
                                 alpha=elnet_best_com_590$alpha, lambda=elnet_best_com_590$alpha)
    elnet_best_fit_591 = glmnet(x=elnet_train_val_591[, -1], y=elnet_train_val_591[, 1], 
                                 alpha=elnet_best_com_591$alpha, lambda=elnet_best_com_591$alpha)
    elnet_best_fit_592 = glmnet(x=elnet_train_val_592[, -1], y=elnet_train_val_592[, 1], 
    ...
    # calculate mse with the best model
    elnet_best_mse_3508 = calculate_mse(model='elnet', fit=elnet_best_fit_3508, elnet_train_val_3508)
    elnet_best_mse_3523 = calculate_mse(model='elnet', fit=elnet_best_fit_3523, elnet_train_val_3523)
    elnet_best_mse_3569 = calculate_mse(model='elnet', fit=elnet_best_fit_3569, elnet_train_val_3569)
    elnet_best_mse_3571 = calculate_mse(model='elnet', fit=elnet_best_fit_3571, elnet_train_val_3571)
    elnet_best_mse_3579 = calculate_mse(model='elnet', fit=elnet_best_fit_3579, elnet_train_val_3579)
    elnet_best_mse_3582 = calculate_mse(model='elnet', fit=elnet_best_fit_3582, elnet_train_val_3582)
    elnet_best_mse_3860 = calculate_mse(model='elnet', fit=elnet_best_fit_3860, elnet_train_val_3860)
    elnet_best_mse_500 = calculate_mse(model='elnet', fit=elnet_best_fit_500, elnet_train_val_500)
    elnet_best_mse_590 = calculate_mse(model='elnet', fit=elnet_best_fit_590, elnet_train_val_590)
    elnet_best_mse_591 = calculate_mse(model='elnet', fit=elnet_best_fit_591, elnet_train_val_591)
    elnet_best_mse_592 = calculate_mse(model='elnet', fit=elnet_best_fit_592, elnet_train_val_592)
    ...
    # Calculate the test mse for individual station
    elnet_test_mse_3508 = calculate_mse(model='elnet', fit=elnet_best_fit_3508, elnet_test_3508)
    elnet_test_mse_3523 = calculate_mse(model='elnet', fit=elnet_best_fit_3523, elnet_test_3523)
    elnet_test_mse_3569 = calculate_mse(model='elnet', fit=elnet_best_fit_3569, elnet_test_3569)
    elnet_test_mse_3571 = calculate_mse(model='elnet', fit=elnet_best_fit_3571, elnet_test_3571)
    elnet_test_mse_3579 = calculate_mse(model='elnet', fit=elnet_best_fit_3579, elnet_test_3579)
    elnet_test_mse_3582 = calculate_mse(model='elnet', fit=elnet_best_fit_3582, elnet_test_3582)
    elnet_test_mse_3860 = calculate_mse(model='elnet', fit=elnet_best_fit_3860, elnet_test_3860)
    elnet_test_mse_500 = calculate_mse(model='elnet', fit=elnet_best_fit_500,elnet_test_500)
    elnet_test_mse_590 = calculate_mse(model='elnet', fit=elnet_best_fit_590,elnet_test_590)
    elnet_test_mse_591 = calculate_mse(model='elnet', fit=elnet_best_fit_591,elnet_test_591)
    elnet_test_mse_592 = calculate_mse(model='elnet', fit=elnet_best_fit_592,elnet_test_592)
    ...
    # Fitting
    xg_best_fit_3508 = xgboost(data=as.matrix(xg_train_val_3508[, -1]), label=xg_train_val_3508[, 1], verbose=0,
                               nrounds=xg_best_com_3508$nrounds, 
                               max_depth=xg_best_com_3508$max_depth, 
                               eta=xg_best_com_3508$eta)
    xg_best_fit_3523 = xgboost(data=as.matrix(xg_train_val_3523[, -1]), label=xg_train_val_3523[, 1], verbose=0,
                               nrounds=xg_best_com_3523$nrounds, 
                               max_depth=xg_best_com_3523$max_depth, 
                               eta=xg_best_com_3523$eta)
    xg_best_fit_3569 = xgboost(data=as.matrix(xg_train_val_3569[, -1]), label=xg_train_val_3569[, 1], verbose=0,
                               nrounds=xg_best_com_3569$nrounds, 
                               max_depth=xg_best_com_3569$max_depth, 
                               eta=xg_best_com_3569$eta)
    xg_best_fit_3571 = xgboost(data=as.matrix(xg_train_val_3571[, -1]), label=xg_train_val_3571[, 1], verbose=0,
                               nrounds=xg_best_com_3571$nrounds, 
                               max_depth=xg_best_com_3571$max_depth, 
                               eta=xg_best_com_3571$eta)
    xg_best_fit_3579 = xgboost(data=as.matrix(xg_train_val_3579[, -1]), label=xg_train_val_3579[, 1], verbose=0,
                               nrounds=xg_best_com_3579$nrounds, 
                               max_depth=xg_best_com_3579$max_depth, 
                               eta=xg_best_com_3579$eta)
    xg_best_fit_3582 = xgboost(data=as.matrix(xg_train_val_3582[, -1]), label=xg_train_val_3582[, 1], verbose=0,
                               nrounds=xg_best_com_3582$nrounds, 
                               max_depth=xg_best_com_3582$max_depth, 
                               eta=xg_best_com_3582$eta)
    xg_best_fit_3860 = xgboost(data=as.matrix(xg_train_val_3860[, -1]), label=xg_train_val_3860[, 1], verbose=0,
                               nrounds=xg_best_com_3860$nrounds, 
                               max_depth=xg_best_com_3860$max_depth, 
                               eta=xg_best_com_3860$eta)
    xg_best_fit_500 = xgboost(data=as.matrix(xg_train_val_500[, -1]), label=xg_train_val_500[, 1], verbose=0,
                               nrounds=xg_best_com_500$nrounds, 
                               max_depth=xg_best_com_500$max_depth, 
                               eta=xg_best_com_500$eta)
    xg_best_fit_590 = xgboost(data=as.matrix(xg_train_val_590[, -1]), label=xg_train_val_590[, 1], verbose=0,
                               nrounds=xg_best_com_590$nrounds, 
                               max_depth=xg_best_com_590$max_depth, 
                               eta=xg_best_com_590$eta)
    xg_best_fit_591 = xgboost(data=as.matrix(xg_train_val_591[, -1]), label=xg_train_val_591[, 1], verbose=0,
                               nrounds=xg_best_com_591$nrounds, 
                               max_depth=xg_best_com_591$max_depth, 
                               eta=xg_best_com_591$eta)
    xg_best_fit_592 = xgboost(data=as.matrix(xg_train_val_592[, -1]), label=xg_train_val_592[, 1], verbose=0,
    ...
    # calculate mse with the best model
    xg_best_mse_3508 = calculate_mse(model='xg', fit=xg_best_fit_3508, xg_train_val_3508)
    xg_best_mse_3523 = calculate_mse(model='xg', fit=xg_best_fit_3523, xg_train_val_3523)
    xg_best_mse_3569 = calculate_mse(model='xg', fit=xg_best_fit_3569, xg_train_val_3569)
    xg_best_mse_3571 = calculate_mse(model='xg', fit=xg_best_fit_3571, xg_train_val_3571)
    xg_best_mse_3579 = calculate_mse(model='xg', fit=xg_best_fit_3579, xg_train_val_3579)
    xg_best_mse_3582 = calculate_mse(model='xg', fit=xg_best_fit_3582, xg_train_val_3582)
    xg_best_mse_3860 = calculate_mse(model='xg', fit=xg_best_fit_3860, xg_train_val_3860)
    xg_best_mse_500 = calculate_mse(model='xg', fit=xg_best_fit_500, xg_train_val_500)
    xg_best_mse_590 = calculate_mse(model='xg', fit=xg_best_fit_590, xg_train_val_590)
    xg_best_mse_591 = calculate_mse(model='xg', fit=xg_best_fit_591, xg_train_val_591)
    xg_best_mse_592 = calculate_mse(model='xg', fit=xg_best_fit_592, xg_train_val_592)
    ...
    # Calculate the test mse for individual station
    xg_test_mse_3508 = calculate_mse(model='xg', fit=xg_best_fit_3508, xg_test_3508)
    xg_test_mse_3523 = calculate_mse(model='xg', fit=xg_best_fit_3523, xg_test_3523)
    xg_test_mse_3569 = calculate_mse(model='xg', fit=xg_best_fit_3569, xg_test_3569)
    xg_test_mse_3571 = calculate_mse(model='xg', fit=xg_best_fit_3571, xg_test_3571)
    xg_test_mse_3579 = calculate_mse(model='xg', fit=xg_best_fit_3579, xg_test_3579)
    xg_test_mse_3582 = calculate_mse(model='xg', fit=xg_best_fit_3582, xg_test_3582)
    xg_test_mse_3860 = calculate_mse(model='xg', fit=xg_best_fit_3860, xg_test_3860)
    xg_test_mse_500 = calculate_mse(model='xg', fit=xg_best_fit_500, xg_test_500)
    xg_test_mse_590 = calculate_mse(model='xg', fit=xg_best_fit_590, xg_test_590)
    xg_test_mse_591 = calculate_mse(model='xg', fit=xg_best_fit_591, xg_test_591)
    xg_test_mse_592 = calculate_mse(model='xg', fit=xg_best_fit_592, xg_test_592)
...
write.csv(final_result, paste0("./result/", version, "/", y_name, "/test/", y_name, "_final_result.csv"), row.names=F)
